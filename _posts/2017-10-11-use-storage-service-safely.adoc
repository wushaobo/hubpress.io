...
=======
image::use_storage_service_safely/chart.png[width=630,height=494]
>>>>>>> update images
...
=======
image::use_storage_service_safely/upload_sequence_diagram.png[width=1104,height=964]

image::use_storage_service_safely/download_sequence_diagram.png[width=820,height=716]
>>>>>>> update images
